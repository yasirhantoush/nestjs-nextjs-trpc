...
export default function Home() {
  ...
  return (
    <div className="flex-col gap-8">
      ...
      {/* header section */}
      <header className="bg-emerald-500/50">
        <section className="">
      ...
      {/* trusted numbers */}
      <section className="">
        <div className="mx-auto bg-gray-500/20 rounded-xl max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
          ...
          <div className="mt-8 sm:mt-12">
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="flex flex-col rounded-lg bg-blue-500/30 px-4 py-8 text-center">
      ...
      {/* testmonials */}
      <section className=" rounded-xl bg-slate-500/20 my-8">
            ...
            <div className="-mx-6 lg:col-span-2 lg:mx-0">
              <div id="keen-slider" className="keen-slider">
                <div className="keen-slider__slide">
                  <blockquote
                    className="flex h-full flex-col justify-between bg-slate-500/10 p-6 shadow-sm sm:p-8 lg:p-12"
                  >
                    <div>
      ...
      <div className="space-y-4 my-8">
        ...
        >
          <summary className="flex cursor-pointer items-center justify-between gap-1.5">
            ...
            <span className="shrink-0 rounded-full p-1.5 sm:p-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <summary className="flex cursor-pointer items-center justify-between gap-1.5">
            ...
            <span className="shrink-0 rounded-full sm:p-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="size-5 shrink-0 transition duration-300 group-open:-rotate-45"
                viewBox="0 0 20 20"
      ...
      {/* footer */}
      <footer className=" bg-emerald-400 rounded-xl">
